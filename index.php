...
<html>
    ...
    <head>
        ...
        <title><?php echo html_entity_decode($title[$lang]); ?></title>
        ...
        <script defer src="./js/commonCoins.js"></script>
        <script defer src="./js/severalCoins.js"></script>
        <script defer src="./js/aDice.js"></script>
        <script defer src="./js/commonDice.js"></script>
        <script defer src="./js/severalDice.js"></script>
        ...
        <div id="container-fluid">
            ...
            <div id="header" class="row text-center">
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        ...
                        <h3><strong><?php echo html_entity_decode($header[$lang]); ?></strong></h3>  

                    </div>

                    <!-- Párrafo de la cabecera -->
                    <div class="panel-body">
                        <h5><?php echo html_entity_decode($headText[$lang]); ?></h5>
                    </div>
            ...
            <div id="centralContainer"> 
                ...
                <ul id="menu">
                    ...
                    <li class="simulation clicked" id="aCoin" onclick="start(id,'<?php echo $lang;?>')"> 
                        <img id="coin" src="./images/coin.svg" class="hidden-xs hidden-sm" alt="Una moneda" />
                        <?php echo html_entity_decode($tab[$lang][0]); ?>
                    </li>

                    <!-- Pestaña "Varias monedas" -->
                    <li class="simulation" id="severalCoins" onclick="start(id,'<?php echo $lang;?>')"> 
                        <img id="coins" src="./images/coins.svg" class="hidden-xs hidden-sm" alt="Varias monedas" />
                        <?php echo html_entity_decode($tab[$lang][1]); ?>
                    </li>

                    <!-- Pestaña "Un dado" -->
                    <li class="simulation" id="aDice" onclick="start(id,'<?php echo $lang;?>')"> 
                        <img id="dice" src="./images/dice-1.svg" class="hidden-xs hidden-sm" alt="Un dado" /> 
                        <?php echo html_entity_decode($tab[$lang][2]); ?>
                    </li>

                    <!-- Pestaña "Varios dados" -->
                    <li class="simulation" id="severalDice" onclick="start(id,'<?php echo $lang;?>')"> 
                        ...
                        <?php echo html_entity_decode($tab[$lang][3]); ?>      
                    </li>    
                ...
                <div id="simulationArea">
                    ...
                    <div class="buttons">
                        ...
                        <!-- Entradas "P(x = Cara)", "Número de monedas", "Tipo de dado" y "Número de dados" -->
                        <div class="inputBtn">   
                        
                            <!-- Entrada "Número de monedas" -->
                            <div class="divCoinsNum">                  
                                <label id="label_coinsNum" for="coinsNum"><?php echo html_entity_decode($coinsNum[$lang][0]); ?></label>
                                <!-- La entrada numérica queda deshabilitada para la pestaña "Una moneda" -->
                                <input type="number" id="coinsNum" min="1" max="8" step="1" value="1" title="<?php echo html_entity_decode($coinsNum[$lang][1]); ?>" disabled /> 
                            </div>      
                    
                            <!-- Entrada "P(x = Cara)" -->
                            <div class="divPx">                  
                                <label id="label_pX" for="pX" title="<?php echo html_entity_decode($pX[$lang][1]); ?>"><?php echo html_entity_decode($pX[$lang][0]); ?></label>
                                <input type="number" id="pX" min="0.1" max="1.0" step="0.1" value="0.0" title="<?php echo html_entity_decode($pX[$lang][2]); ?>" /> 
                            </div>
            
                            <!-- Entrada "Tipo de dado" --> 
                            <div class="divDiceType">  
                                <label id="label_diceType"><?php echo html_entity_decode($diceType[$lang][0]); ?></label>                
                                <select id="diceType" class="diceType" title="<?php echo html_entity_decode($diceType[$lang][1]); ?>" onclick="chooseDiceType()">
                                    <option id="defDiceType" value=""></option>
                                    <option id="perfectDice" value="Perfecto"><?php echo html_entity_decode($diceType[$lang][2]); ?></option>
                                    <option id="trickedDice" value="Trucado"><?php echo html_entity_decode($diceType[$lang][3]); ?></option>                                
                                </select> 
                            </div>  

                            <!-- Entrada "Número de dados" -->                                      
                            <div class="divDiceNum">                  
                                <label id="label_diceNum" for="diceNum"><?php echo html_entity_decode($diceNum[$lang][0]); ?></label>
                                <input type="number" id="diceNum" min="2" max="8" step="1" value="2" title="<?php echo html_entity_decode($diceNum[$lang][1]); ?>" />                                              
                            </div>
                                             
                        </div>
                        <!-- FIN de Entradas "P(x = Cara)", "Número de monedas", "Tipo de dado" y "Número de dados" -->
                    
                        <!-- Entradas "P(x = y)" -->
                        <div class="diceProb">
                        
                        <div style="min-width: 300px;">  <!--Buscar nº de píxeles exactos -->     
                        <!-- Entrada "P(x = 1)" -->
                                <div class="pXy">                  
                                    <label id="label_pX1" for="pX1">P(x = 1):</label>
                                    <input type="number" id="pX1" min="0.1" max="1.0" step="0.1" value="0.0" title="<?php echo html_entity_decode($diceProb[$lang][0]); ?>" />
                                    <label id="label_pX2" for="pX2">P(x = 2):</label>
                                    <input type="number" id="pX2" min="0.1" max="1.0" step="0.1" value="0.0" title="<?php echo html_entity_decode($diceProb[$lang][1]); ?>" /> 
                                    <label id="label_pX3" for="pX3">P(x = 3):</label>
                                    <input type="number" id="pX3" min="0.1" max="1.0" step="0.1" value="0.0" title="<?php echo html_entity_decode($diceProb[$lang][2]); ?>" /> 
                                </div>  
...
<div> -->
                                ...
                                <div class="pXy">                  
                                    ...
                                    <input type="number" id="pX4" min="0.1" max="1.0" step="0.1" value="0.0" title="<?php echo html_entity_decode($diceProb[$lang][3]); ?>" /> 
                                    <label id="label_pX5" for="pX5">P(x = 5):</label>
                                    <input type="number" id="pX5" min="0.1" max="1.0" step="0.1" value="0.0" title="<?php echo html_entity_decode($diceProb[$lang][4]); ?>" /> 
                                    <label id="label_pX6" for="pX6">P(x = 6):</label>
                                    <input type="number" id="pX6" min="0.1" max="1.0" step="0.1" value="0.0" title="<?php echo html_entity_decode($diceProb[$lang][5]); ?>" /> 
                                </div>  
</div>
                        ...
                        <div class="actionBtn">   
                            ...
                            <!-- Agrupamos los botones de dos en dos para su representación en pantallas pequeñas-->
                            <div>

                                <!-- Botón "Uno a uno" -->
                                <div class="btn">
                                    <button id="oneByone" title="<?php echo html_entity_decode($button[$lang][0]);?>" onclick="simulate(id, '<?php echo $lang;?>')">
                                        <?php echo html_entity_decode($button[$lang][1]);?>
                                    </button>
                                </div>  
                        
                                <!-- Botón "Número fijo" -->
                                <div class="btn">
                                    <button id="fixedNum" title="<?php echo html_entity_decode($button[$lang][2]);?>" onclick="simulate(id, '<?php echo $lang;?>')">
                                        <?php echo html_entity_decode($button[$lang][3]);?>
                                    </button>
                            ...
                            <div>
                                ...
                                <!-- Botón "Continuo" -->
                                <div class="btn">
                                    <button id="continuous" title="<?php echo html_entity_decode($button[$lang][4]);?>" onclick="simulate(id, '<?php echo $lang;?>')">
                                        <?php echo html_entity_decode($button[$lang][5]);?>
                                    </button>
                                </div>                        

                                <!-- Botón "Reiniciar" -->
                                <div class="btn">
                                    <button id="restart" title="<?php echo html_entity_decode($button[$lang][8]);?>" onclick="simulate(id, '<?php echo $lang;?>')">
                                        <?php echo html_entity_decode($button[$lang][9]);?>
                                    </button>
                                </div>  
                    ...
                    <div class="stopBtn">
                        ...
                        <!-- Botón "Detener" -->
                        <div class="btn">
                            <button id="stop" title="<?php echo html_entity_decode($button[$lang][6]);?>" onclick="simulate(id, '<?php echo $lang;?>')">
                                <?php echo html_entity_decode($button[$lang][7]);?> 
                            </button>
                        </div> 
                    ...
                    <div class="bottomLegend">
                        ...
                        <!-- Dato 12 -->
                        <div class="divText12">
                            <label id="label12" for="text12"></label>
                            <span id="text12"></span> 
                        </div>
